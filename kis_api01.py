...
# ord_psbl_cash_value_1 = rt_data.loc[0, 'ord_psbl_cash'] # ord_psbl_cash	주문가능현금
# ord_psbl_cash_value_2 = rt_data.loc[0, 'nrcvb_buy_amt'] # nrcvb_buy_amt	미수없는매수가능금액
# print(ord_psbl_cash_value_1, ord_psbl_cash_value_2)
